...
public class ASTNodeExpressionPrimeSubtractive implements ASTNodeExpressionPrime {
    private Token token;
    private ASTNodeTerm term;
    private ASTNodeExpressionPrime expPrime;

    public ASTNodeExpressionPrimeSubtractive(Token token, ASTNodeTerm term, ASTNodeExpressionPrime expPrime) {
        this.token = token;
        this.term = term;
