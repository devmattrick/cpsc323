...
// <Term’> -> * <Factor> <Term’>
public class ASTNodeTermPrimeMultiplicative implements ASTNodeTermPrime {
    private Token token;
    private ASTNodeFactor factor;
    private ASTNodeTermPrime termPrime;

    public ASTNodeTermPrimeMultiplicative(Token token, ASTNodeFactor factor, ASTNodeTermPrime termPrime) {
        this.token = token;
        this.factor = factor;
